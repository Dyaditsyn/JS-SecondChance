...
const sum = socksPrice + jacketPrice + jeansPrice;
...
const intSum = Math.trunc(socksPrice) + Math.trunc(jacketPrice) + Math.trunc(jeansPrice);
...
const profit = +(sum/2 - discount).toFixed(2); 
